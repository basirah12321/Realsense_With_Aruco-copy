    ...
    try:
        ...
        while (showLive):
            ...
            for (i, b) in enumerate(corners):
                ...
                point_up = [x_robot, y_robot, 550.42, -170, 0.27, -90]
                run_point_MOVJ(move, point_up)
                wait_arrive(point_up)
                sleep(0.1)

                #point_up = [354.29,-140.29,550.42,-179.97,0.27,-89.99] #poin up ที่ยกของขึ้น
                #run_point_MOVJ(move, point_up)
                #wait_arrive(point_up)
                #sleep(0.5)
                ...
                #point_scanbarcode1 = [670.09,245.04,556.15,-174.28,0.14,119.23] #poin scanbarcobe
